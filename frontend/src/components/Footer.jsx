        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href={`https://zalo.me/${phoneTel}`} target="_blank" rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li>
                <a href={`tel:${phoneTel}`} className="flex gap-2 hover:text-primary-400 transition-colors">
